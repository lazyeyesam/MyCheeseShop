    ...
    public class DatabaseSeeder
    {
        ...
        public async Task Seed()
        {
            ...
            if (!_context.Users.Any()) 
            {
                ...
                var userEmail = "sam@example.com";
                var userPassword = "Sam123!";
                ...
                await _userManager.CreateAsync(customer, userPassword);
            ...
            return new List<Cheese>
        {
            ...
            new Cheese { Name = "Monterey Jack Magic", Type = "Semi-Soft", Description = "A versatile American cheese with a mild and buttery taste, great for melting on nachos, sandwiches, or adding to omelets for extra creaminess.", Strength = "Medium", Price = 7.49m }
        };
        }
    }
}
